...
{
    public partial class HuyDonXuatcs : UserControl
    {
        ...
        private void HuyDonXuatcs_Load(object sender, EventArgs e)
        {
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            {
                PhieuXuatId = int.Parse(textBox1.Text),
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn không có quyền duyệt đơn xuất kho");
            }
        }
